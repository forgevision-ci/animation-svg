...
## [Debug](debug/debug_animated.svg)

1. Phase1 (0.3s~0.55s): 虫の前面の縦線が下から上へ伸びる
2. Phase2 (0.55s~1.05s): 上の頂点で右折し、斜め45°右下方向へ三角形の右辺が描画される
3. Phase3 (1.05s~1.4s): 右下の頂点で右折し、左方向へ下辺が戻って描画完了